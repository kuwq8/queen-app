...
const modalIndex = content.indexOf('      {/* New Chat Modal */}');

if (startIndex !== -1 && modalIndex !== -1) {
  content = content.substring(0, startIndex) + newRender + content.substring(modalIndex + 28);
} else {
